...
const GenreFilterComponent: React.FC<GenreFilterProps> = ({ genres, activeGenre, onGenreChange }) => {
  return (
    <div className="flex items-center space-x-2 overflow-x-auto pb-2 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8" style={{ scrollbarWidth: 'none', '-ms-overflow-style': 'none' }}>
