...
interface HowToDownloadPageProps {
  onBack: () => void;
}

export const HowToDownloadPage: React.FC<HowToDownloadPageProps> = ({ onBack }) => {
  return (
    <StaticPageLayout title="How to Download" onBack={onBack}>
