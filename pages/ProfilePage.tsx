...
export const ProfilePage: React.FC<ProfilePageProps> = ({ userProfile, setUserProfile, onNavigate, onBack, theme, onThemeToggle, onLogout }) => {
  ...
  if (!userProfile) {
    return null; // Should be redirected by App.tsx, this is a safeguard.
  }
